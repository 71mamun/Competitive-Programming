...
total cost minimize korley maximum cut ta minimize hobe na.
maximum cut ta minimize totol cost minimum na hoileo hote pare.

inf use korle long long use korinai inf er + operation thkale limit check kora.
