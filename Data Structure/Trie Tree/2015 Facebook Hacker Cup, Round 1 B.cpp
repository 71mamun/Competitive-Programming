...
#define maxWordLength 1000000
#define SZ 1000010  ///edit_needed - number of char in the dictionary
...
int main()
{
    int T,n,t=1;char str[maxWordLength];init();
    sf("%d",&T);
    while(T--)
    {
        Delete();
        ...
        For(i,0,n-1)
        {
            ...
            int loc_ans=Search(str,strlen(str));
            ans+=loc_ans;
        }
        pf("Case #%d: %d\n",t++,ans);
    }
