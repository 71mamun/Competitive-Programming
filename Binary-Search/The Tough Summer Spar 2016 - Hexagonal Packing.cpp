///https://toph.ws/c/tough-summer-spar-2016/arena#!/p/hexagonal-packing
#include<bits/stdc++.h>
using namespace std;
#define     ll                      long long
...
bool ok(double d)
{
    double dis = sqr(n*d)+sqr((n-1)*d)-2*n*(n-1)*sqr(d)*cos((PI/180.0)*120.0);
    return dis<=r*r;
}
