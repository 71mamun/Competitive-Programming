...
/**
    ...
    example 2 nd test case:
    only 2unit of type j1 ans is 1.
    now 2unit of type j2 comes. one j2 must be placed
    at last to secure others job finish first.
    now previous permutation was only "j1j1" now the
    remaining 1unit of j2 can be parmutet with out changing
    the previous order of job unit is 3C1 = 3. and they are
    J1 J1 J2 J2
    J1 J2 J1 J2
    J2 J1 J1 J2
    now 3unit of j3 comes 1unit set at last and remaining 2unit
    can be parmutet with out changing the previous order of job
    unit is 6C2 for every solution of previous state.
    previous 4 ta pos and new 2 pos total 6 pos theke 2 ta position
    koto vabe nite pari ar baki 4 pos e previous order e ager 4 ta bosay
    dibo.
