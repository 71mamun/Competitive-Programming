///https://toph.ws/c/nsu-code-masters-2016-r/arena#!/p/fast-co-prime
#include<bits/stdc++.h>
using namespace std;
#define     ll                      long long
